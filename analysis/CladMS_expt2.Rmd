...
We can also compare the posterior distributions of each group to the negative control to get similar metrics of significance and effect size.
...
data.frame(
  ...
  HDI = apply(neg_pr, 2, function(x) paste(round(as.numeric(bayestestR::hdi(x, ci=0.89)[2:3]),2), sep="",collapse = "-") )) %>%
